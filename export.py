...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/Leo_F.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'ptah/pt', help='model.pt path(s)')
